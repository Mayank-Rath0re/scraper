...
import '../endpoints/extract_endpoint.dart' as _i3;
import '../endpoints/scrape_endpoint.dart' as _i4;
import 'package:scrap_server/src/generated/db_process.dart' as _i5;
import 'package:scrap_server/src/generated/db_scrapers.dart' as _i6;
import 'package:scrap_server/src/generated/db_email.dart' as _i7;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'extract': _i3.ExtractEndpoint()
        ..initialize(
          server,
          'extract',
          null,
        ),
      'scrape': _i4.ScrapeEndpoint()
        ..initialize(
          server,
          'scrape',
          null,
        ...
        'retrieveAllProcess': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['extract'] as _i3.ExtractEndpoint)
        ...
        'retrieveSearchQuery': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['extract'] as _i3.ExtractEndpoint).retrieveSearchQuery(
            session,
            params['nichePattern'],
        ...
        'retrieveByStatus': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['extract'] as _i3.ExtractEndpoint).retrieveByStatus(
            session,
            params['status'],
          ),
        ),
        'prepareExtractData': _i1.MethodConnector(
          ...
          params: {
            'process': _i1.ParameterDescription(
              name: 'process',
              type: _i1.getType<_i5.DBProcess>(),
              nullable: false,
            )
          },
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['extract'] as _i3.ExtractEndpoint).prepareExtractData(
            session,
            params['process'],
          ),
        ),
        ...
        'startNewScrape': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).startNewScrape(
            session,
            params['niche'],
            params['locations'],
            mode: params['mode'],
        ...
        'queueScraper': _i1.MethodConnector(
          ...
          params: {
            'scraper': _i1.ParameterDescription(
              name: 'scraper',
              type: _i1.getType<_i6.DBScrapers>(),
              nullable: false,
            )
          },
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).queueScraper(
            session,
            params['scraper'],
          ),
        ),
        'dashboardData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint)
        ...
        'searchRetrieval': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).searchRetrieval(
            session,
            params['searchId'],
          ),
        ),
        'retrieveAll': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).retrieveAll(session),
        ),
        'statusCount': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).statusCount(
            session,
            params['scraperId'],
          ),
        ),
        'interruptScraping': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).interruptScraping(
            session,
            params['scraper'],
          ),
        ),
        'startScraping': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).startScraping(
            session,
            params['scraper'],
          ),
        ),
        ...
        'startVerification': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).startVerification(
            session,
            params['emailObject'],
          ),
        ),
        'retrieveByStatus': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).retrieveByStatus(
            session,
            params['status'],
          ),
        ),
        'pauseProcess': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).pauseProcess(
            session,
            params['scraper'],
          ),
        ),
        'retrieveSelected': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).retrieveSelected(
            session,
            params['scraperIds'],
          ),
        ),
        'stopProcess': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['scrape'] as _i4.ScrapeEndpoint).stopProcess(
            session,
            params['scraper'],
          ),
        ),
