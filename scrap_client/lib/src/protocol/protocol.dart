...
import 'package:scrap_client/src/protocol/db_email.dart' as _i7;
import 'package:scrap_client/src/protocol/db_process.dart' as _i8;
import 'package:scrap_client/src/protocol/db_scrapers.dart' as _i9;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i7.DBEmail>) {
      return (data as List).map((e) => deserialize<_i7.DBEmail>(e)).toList()
          as dynamic;
    }
    if (t == List<_i8.DBProcess>) {
      return (data as List).map((e) => deserialize<_i8.DBProcess>(e)).toList()
          as dynamic;
    }
    if (t == List<String>) {
      return (data as List).map((e) => deserialize<String>(e)).toList()
    ...
    if (t == List<_i9.DBScrapers>) {
      return (data as List).map((e) => deserialize<_i9.DBScrapers>(e)).toList()
          as dynamic;
    }
